...
\begin{frame}
	%\frametitle{Erfa-Kreise}
	\begin{enumerate}
		\item Holt euch ein Board + USB-Kabel
		\item Besorgt euch die VM + VMware Player
		\item Kriegt die VM ans laufen
		\item Versucht die Library auf der Commandline zu kompilieren
		\item Versucht das Blink-Example zu flashen
		\item Erstellt ein neues Projekt
		\item Lasst etwas Debugoutput ausgeben
		\item Testet den Debugoutput mit stlink-trace
	\end{enumerate}
\end{frame}
